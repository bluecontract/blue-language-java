...
class RootedReleaseLayoutTest(unittest.TestCase):
    ...
    def test_packaged_resource_continuation_plan_requires_exact_real_sequence(self):
        ...
        edits = [lambda p: p['setup'][0].__setitem__('isolatedDatabase', False),
                 ...
                 lambda p: p['variants']['baseline'][8].pop('awaitReadiness'),
                 lambda p: p['variants']['baseline'][8].__setitem__('awaitReadiness', False),
                 lambda p: p['variants']['baseline'][8].__setitem__('awaitReadiness', 1),
