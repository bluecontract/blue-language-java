...
SUPPORTED_PUBLIC_TYPES_BY_PACKAGE = {
    ...
    "blue.language.snapshot": {
        ...
        "ExactNodeStorageCodec",
        "FrozenNode",
        "FrozenNodeStorageCodec",
        "ImmutableBluePatch",
        "ResolvedSnapshot",
    },
    ...
    "blue.language.processor": {
        ...
        "ExactEventIdentityEvidenceStorageCodec",
    ...
    "blue.language.processor.closure": {
        "AffectedClosureSnapshotStorageCodec",
        "ClosureExecutionEvidenceStorageCodec",
        "ClosureProcessResultStorageCodec",
