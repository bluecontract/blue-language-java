...
public class DirectBlueIdCalculatorTest {
        ...
        public void shouldCalculateSameBlueIdAcrossObjectRepresentations() {
                ...
                String result1 = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(map1);
                ...
                String result2 = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(map2);
                ...
                String result3 = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(map3);
                ...
                String result4 = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(map4);
        ...
        public void shouldPreserveEmptyList() {
                ...
                // when
                String result = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(map);
        ...
        public void shouldDistinguishNestedListFromFlatList() {
                ...
                String flatResult = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(YAML_MAPPER.readValue(flat, Map.class));
                // when
                String nestedResult = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(YAML_MAPPER.readValue(nested, Map.class));
        ...
        public void shouldSeedListHashFromPreviousListAnchor() {
                ...
                // when
                String result = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(YAML_MAPPER.readValue(anchored, Map.class));
        ...
        public void shouldRejectPositionOverlayForDirectBlueId() {
                ...
                IllegalArgumentException failure = captureFailure(
                                () -> new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(YAML_MAPPER.readValue(withPosition, Map.class)));
        ...
        public void shouldRejectReplaceOverlayForDirectBlueId() {
                ...
                // when
                IllegalArgumentException failure = captureFailure(
                                () -> new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(YAML_MAPPER.readValue(withReplace, Map.class)));
        ...
        public void shouldRejectInvalidListControlsDuringHashing() {
                // given
                DirectBlueIdCalculator calculator = new DirectBlueIdCalculator(fakeHashValueProvider());

                // when
                IllegalArgumentException[] failures = {
                        captureFailure(() -> calculator.directBlueIdFromCanonicalInput(YAML_MAPPER.readValue(
                                "abc:\n" +
                                "  - value: A\n" +
                                "  - $previous:\n" +
        ...
        public void shouldHashEmptyPlaceholderAsContent() {
                ...
                String placeholderResult = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(YAML_MAPPER.readValue(placeholder, Map.class));
                // when
                String emptyResult = new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(YAML_MAPPER.readValue(empty, Map.class));
        ...
        public void shouldShortCircuitPureReference() {
                ...
                // then
                assertEquals("asserted-id", calculator.directBlueIdFromCanonicalInput(pureReference));
                assertNotEquals("asserted-id", calculator.directBlueIdFromCanonicalInput(mixedNode));
        }

        @Test
        public void shouldHashScalarNumbersAndStringsAsDifferentJsonTypes() {
                // given
                DirectBlueIdCalculator calculator = DirectBlueIdCalculator.INSTANCE;
                ...
                // when
                String integerBlueId = calculator.directBlueIdFromCanonicalInput(integerValue);
                String integerTextBlueId = calculator.directBlueIdFromCanonicalInput(integerText);
                String booleanBlueId = calculator.directBlueIdFromCanonicalInput(booleanValue);
                String booleanTextBlueId = calculator.directBlueIdFromCanonicalInput(booleanText);
        ...
        public void shouldSortObjectProperties() {
                ...
                // when
                String blueId2 = DirectBlueIdCalculator.calculateBlueId(node2);
        ...
        public void shouldSortLexicographically() {
                ...
                // then
                assertEquals(expectedBlueId, new DirectBlueIdCalculator(fakeHashValueProvider()).directBlueIdFromCanonicalInput(map));
        }
        ...
        public void shouldCalculateSameBlueIdForDoubleIntegerDecimalAndStringForms() {
                ...
                String integerBlueId = DirectBlueIdCalculator.calculateBlueId(YAML_MAPPER.readValue(integerYaml, Node.class));
                String decimalBlueId = DirectBlueIdCalculator.calculateBlueId(YAML_MAPPER.readValue(decimalYaml, Node.class));
                // when
                String stringBlueId = DirectBlueIdCalculator.calculateBlueId(YAML_MAPPER.readValue(stringYaml, Node.class));
        ...
        public void shouldCanonicalizeDoubleOneThirdAcrossComputedAndAuthoredForms() {
                ...
                // when
                String computedBlueId = DirectBlueIdCalculator.calculateBlueId(computed);
                String authoredNumberBlueId = DirectBlueIdCalculator.calculateBlueId(
                                YAML_MAPPER.readValue(authoredNumber, Node.class));
                String authoredStringBlueId = DirectBlueIdCalculator.calculateBlueId(
                                YAML_MAPPER.readValue(authoredString, Node.class));
                String inferredDoubleBlueId = DirectBlueIdCalculator.calculateBlueId(
        ...
        public void shouldRemoveNullAndEmptyValues() {
                ...
                String result3 = DirectBlueIdCalculator.calculateBlueId(node3);
                String result4 = DirectBlueIdCalculator.calculateBlueId(node4);
                // when
                String result5 = DirectBlueIdCalculator.calculateBlueId(node5);
        ...
        public void shouldRequireCanonicalBlueIdsDuringExplicitBlueIdInputParsing() {
                // given
                Blue blue = new Blue();
                String validBlueId = DirectBlueIdCalculator.calculateBlueId(new Node().value("x"));
        ...
        public void shouldRejectInvalidReferenceBlueIdsInStaticCalculator() {
                ...
                // when
                IllegalArgumentException[] failures = {
                        captureFailure(() -> DirectBlueIdCalculator.calculateBlueId(
        ...
        public void shouldRejectUnresolvedTypeAliasesForDirectBlueId() {
                ...
                // when
                RuntimeException[] failures = {
                        captureFailure(() -> DirectBlueIdCalculator.calculateBlueId(typeAlias)),
                        captureFailure(() -> DirectBlueIdCalculator.calculateBlueId(itemTypeAlias)),
                        captureFailure(() -> DirectBlueIdCalculator.calculateBlueId(mapTypeAliases)),
        ...
        public void shouldRejectTypeAliasForDirectBlueId() {
                ...
                // when
                IllegalArgumentException failure =
                        captureFailure(() -> DirectBlueIdCalculator.calculateBlueId(node));
        ...
        public void shouldNormalizeNullSourceListToEmptyPlaceholder() {
                ...
                assertNotEquals(DirectBlueIdCalculator.calculateBlueId(compact), DirectBlueIdCalculator.calculateBlueId(withNull));
        }
        ...
        public void shouldRejectNullListElementForDirectBlueId() {
                ...
                // when
                IllegalArgumentException failure = captureFailure(
                                () -> DirectBlueIdCalculator.calculateBlueId(withNull));
        ...
        public void shouldUseTypedScalarIdentityForNestedBareSchemaScalar() {
                ...
                String explicitBlueId =
                        DirectBlueIdCalculator.calculateBlueId(withExplicitTypedScalar);
                String bareBlueId =
                        DirectBlueIdCalculator.calculateBlueId(withBareSchemaScalar);
        ...
        public void shouldMatchPublishedContracts10IdentityForCheckpointEntry() throws Exception {
                ...
                try (InputStream input = getClass().getClassLoader().getResourceAsStream(
                        ...
                        if (resourcePresent) {
                                ...
                                actual = DirectBlueIdCalculator.calculateBlueId(checkpointEntry);
                        }
                }
