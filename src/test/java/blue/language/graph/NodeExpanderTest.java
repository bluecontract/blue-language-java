...
public class NodeExpanderTest {
    ...
    public void shouldExpandList() throws Exception {
        ...
        String listBlueId = DirectBlueIdCalculator.calculateBlueId(Arrays.asList(nodeA, nodeB));
    ...
    public void shouldExpandListDirectly() throws Exception {
        ...
        String listABBlueId = DirectBlueIdCalculator.calculateBlueId(Arrays.asList(nodeA, nodeB));
        ...
        String listABCBlueId = DirectBlueIdCalculator.calculateBlueId(Arrays.asList(nodeAB, nodeC));
