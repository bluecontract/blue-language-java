...
public class LimitsXyzTest {
    ...
    private Node resolve(Limits limits) throws IOException {
        ...
        String filename = "src/test/java/blue/language/samples/testsXyz/Xyz.blue";
