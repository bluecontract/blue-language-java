...
def gas_trace_loop(limit: int) -> tuple[list[dict[str, Any]], int, str, int]:
    ...
    trace_identity = sha_id("blue-contracts-gas-trace/1.0", trace)
...
def generate() -> None:
    ...
    dump(FIXTURE_DIR/"c-clo-02-dynamic-finite-cycle.yaml", base_fixture(
        "c-clo-02-dynamic-finite-cycle",["C-CLO-02","C-CLO-03","C-CLO-29","C-CLO-30"],"cycle","process-closure",
    ...
    dump(FIXTURE_DIR/"c-clo-12-frozen-edge-removal.yaml",base_fixture("c-clo-12-frozen-edge-removal",["C-CLO-12"],"ordering","process-closure","An event occurrence created before edge retirement retains its frozen target exactly once; retirement affects only later occurrences.",None,frozen_before,frozen_expected))
