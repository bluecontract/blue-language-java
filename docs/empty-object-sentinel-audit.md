...
- Production matches: 2158
- Decision-relevant matches: 256
- Context-only broad-search matches: 1902
- Matches in files changed since the RC baseline: 1303
...
| `context-only-not-empty-sentinel-decision` | 1902 |
