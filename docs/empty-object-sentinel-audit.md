...
- Production matches: 2106
- Decision-relevant matches: 256
- Context-only broad-search matches: 1850
- Matches in files changed since the RC baseline: 1216
- Matches in unchanged files: 890
...
| `context-only-not-empty-sentinel-decision` | 1850 |
