...
- Contracts: `sha256:684d691c11aa16f87e1d56fa7a331a4267cddf9fbda3193fb33d84eeaabf92b6`, 25 production and three fixture entries. The contextual-reference repair corrects `CheckpointEntry.domain` to the exact-node contract; see [the repair contract](reviews/pr36-contextual-reference-repair.pl.md).
